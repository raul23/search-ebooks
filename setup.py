"""setup.py file for the package ``searchebooks``.

The PyPi project name is ``search-ebooks`` and the package name is
``searchebooks``.
...
from searchebooks import __version__, __test_version__

if sys.version_info < (3, 6):
    raise RuntimeError("""
    searchebooks v0.1.0+ supports Python 3.6 and above. 
    """)

excluded = ['searchebooks/configs/config.py',
            'searchebooks/configs/logging.py']
...
setup(name='search-ebooks',
      version=VERSION,
      description='Command-line program that searches through content and '
      ...
      keywords='calibre command-line ebook script search search-in-text',
      url='https://github.com/raul23/search-ebooks',
      author='Raul C.',
      ...
      entry_points={
        'console_scripts': ['search-ebooks=searchebooks.scripts.search-ebooks:main']
      },
      project_urls={  # Optional
          'Bug Reports': 'https://github.com/raul23/search-ebooks/issues',
          # TODO: 'Documentation': 'https://?.readthedocs.io/',
          'Source': 'https://github.com/raul23/search-ebooks',
      },
      zip_safe=False)
